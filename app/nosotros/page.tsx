...
export default function NosotrosPage() {
  const teamMembers = [
    ...
    { name: 'Yeny López', role: 'Integrante del equipo', image: '/images/yeny-lopez.jpg' },
    { name: 'Lorena Marcelo', role: 'Integrante del equipo', image: '/images/lorena-marcelo.jpg' },
    { name: 'Alessandro Pérez', role: 'Integrante del equipo', image: '/images/alessandro-perez.jpg' },
    { name: 'Rocío Romero', role: 'Integrante del equipo', image: '/images/rocio-romero.jpg' },
    { name: 'Janeth Siapo', role: 'Integrante del equipo', image: '/images/janeth-siapo.jpg' },
